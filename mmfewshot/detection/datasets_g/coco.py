...
# COCO_SPLIT = dict(
#     ALL_CLASSES=('truck', 'traffic light', 'fire hydrant', 'stop sign',
#                  'parking meter', 'bench', 'elephant', 'bear', 'zebra',
#                  'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
#                  'suitcase', 'frisbee', 'skis', 'snowboard', 'sports ball',
#                  'kite', 'baseball bat', 'baseball glove', 'skateboard',
...
class FewShotCocoDefaultDataset(FewShotCocoDataset):
    ...
    coco_benchmark = {
        f'{shot}SHOT': [
            dict(
                type='ann_file',
                ann_file=f'/home/f523/disk1/sxp/dataset/coco/benchmark_{shot}shot/'
    ...
    DEFAULT_ANN_CONFIG = dict(
        ...
        Attention_RPN={
            **coco_benchmark, 'Official_10SHOT': [
                dict(
                    type='ann_file',
                    ann_file='data/coco/attention_rpn_10shot/'
