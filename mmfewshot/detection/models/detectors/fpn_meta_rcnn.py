...
class FPNMetaRCNN(QuerySupportDetector):
    ...
    def forward_train(self,
        ...
        roi_losses = self.roi_head.forward_train(query_feats_de_rpn, query_data['img_metas'], proposal_list,
                                                 gt_bboxes=query_data['gt_bboxes'], gt_labels=query_data['gt_labels'],
                                                 gt_bboxes_ignore=query_data.get('gt_bboxes_ignore', None), gt_masks=None,
                                                 **kwargs)
    ...
    def simple_test_temp(self,
        ...
        roi_results = self.roi_head.simple_test(
            query_feats, proposal_list, img_metas, rescale=rescale)
