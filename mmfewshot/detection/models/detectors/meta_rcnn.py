...
class MetaRCNN(QuerySupportDetector):
    ...
    def simple_test(self,
        ...
        #     support_feats.append(self.inference_support_dict[key][:1024])
        # pdb.set_trace()
        # generstae_featmap(query_feats[-1], support_feats, img.detach().cpu().numpy(), img_metas[0]['filename'])
