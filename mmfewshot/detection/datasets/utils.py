...
def get_copy_dataset_type(dataset_type: str) -> str:
    ...
    if dataset_type in ['FewShotVOCDataset', 'FewShotVOCDefaultDataset']:
        ...
        copy_dataset_type = 'FewShotDIORCopyDataset'
            ...
            'FewShotdcDataset', 'FewShotdcDatasetV2',
            'FewShotdcDefaultDataset', 'FewShotdcDefaultDatasetWithSeedK',
    ]:
        copy_dataset_type = 'FewShotdcCopyDataset'
    elif dataset_type in [
            'FewShotF2ODDataset',
    ]:
    ...
    elif dataset_type in ['FewShotNWPUV2Dataset', 'FewShotNWPUV2DefaultDataset', 'FewShotNWPUV2CopyDataset']:
        copy_dataset_type = 'FewShotNWPUV2CopyDataset'
    else:
