...
NWPUV2_SPLIT = dict(
    ALL_CLASSES_SPLIT1=('basketball', 'bridge', 'groundtrackfield',
                        'harbor', 'ship', 'storagetank', 'vehicle', 'airplane', 'baseball', 'tenniscourt'),
    ...
    ALL_CLASSES_SPLIT2=('airplane', 'baseball', 'bridge',
                        'harbor', 'ship', 'storagetank', 'tenniscourt', 'basketball', 'groundtrackfield', 'vehicle'),
    ...
    ALL_CLASSES_SPLIT3=('airplane', 'bridge', 'groundtrackfield',
                         'harbor', 'ship', 'storagetank', 'tenniscourt', 'basketball', 'baseball', 'vehicle'),
    NOVEL_CLASSES_SPLIT3=('basketball', 'baseball', 'vehicle'),
