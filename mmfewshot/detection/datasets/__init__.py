...
from .dc import dc_SPLIT, FewShotdcDataset
from .nwpuv2 import NWPUV2_SPLIT, FewShotNWPUV2Dataset
...
__all__ = [
    ...
    'FewShotVHR10DefaultDataset', 'MAR20_SPLIT', 'FewShotMAR20Dataset', 'dc_SPLIT', 'FewShotdcDataset',
    'NWPUV2_SPLIT', 'FewShotNWPUV2Dataset'
]
