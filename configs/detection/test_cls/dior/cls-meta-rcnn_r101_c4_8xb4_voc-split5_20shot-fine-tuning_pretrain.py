...
model = dict(
    ...
    roi_head=dict(
        ...
        shared_head=dict(
            ...
            pretrained='/home/f523/disk1/sxp/mmfewshot/pretrain/resnet101_msra-6cc46731.pth',
            depth=101,
            stage=3,
            stride=2,
            dilation=1,
...
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split5_20shot-fine-tuning_pretrain'
gpu_ids = [0]
