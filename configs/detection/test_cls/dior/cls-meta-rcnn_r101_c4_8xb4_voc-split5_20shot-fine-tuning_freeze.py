...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100)),
    frozen_parameters=[
        'backbone', 'shared_head', 'rpn_head', 'aggregation_layer', 'roi_head.gnn'
...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split5_base-training_asy/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split5_20shot-fine-tuning_freeze'
gpu_ids = [0]
