...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split5_base-training_simtext/iter_42000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split5_20shot-fine-tuning_simtext'
gpu_ids = [0]
