...
data = dict(
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file', ann_file='data/DIOR/ImageSets/Main/base.txt')
        ],
        img_prefix='data/DIOR/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
evaluation = dict(interval=30000, metric='mAP')
...
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split1_base-training_ngnn_plus_augtext_mask_fpn'
gpu_ids = [0]
