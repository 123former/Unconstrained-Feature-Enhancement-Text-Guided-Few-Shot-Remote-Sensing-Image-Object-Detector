...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-split1_base-training_ngnn_plus_augtext_mask/iter_60000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-SPLIT1_base-training_ngnn_plus_asy'
gpu_ids = [0]
