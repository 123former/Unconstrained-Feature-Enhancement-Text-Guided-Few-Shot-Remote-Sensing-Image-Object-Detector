...
data = dict(
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file', ann_file='data/DIOR/ImageSets/Main/vis.txt')
        ],
        img_prefix='data/DIOR/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
log_level = 'INFO'
load_from = './work_dirs/metarcnn_r101_dior-split1_base-training/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/meta-rcnn_r101_c4_8xb4_dior-split1_20shot-fine-tuning'
gpu_ids = [0]
