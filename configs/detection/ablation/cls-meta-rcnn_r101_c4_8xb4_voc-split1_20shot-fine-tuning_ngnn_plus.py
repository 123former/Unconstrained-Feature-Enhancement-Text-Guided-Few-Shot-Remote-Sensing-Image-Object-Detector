...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-SPLIT1_base-training_ngnn_plus/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_voc-SPLIT1_20shot-fine-tuning_ngnn_plus'
gpu_ids = [0]
