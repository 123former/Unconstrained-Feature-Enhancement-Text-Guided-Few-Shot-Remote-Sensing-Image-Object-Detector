...
data_root = '/home/f523/disk1/sxp/dataset/coco/'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[
                dict(
                    type='ann_file',
                    ann_file='/home/f523/disk1/sxp/dataset/coco/cocosplit/datasplit/train.json')
            ],
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='/home/f523/disk1/sxp/dataset/coco/cocosplit/datasplit/val.json')
        ],
        img_prefix=data_root,
