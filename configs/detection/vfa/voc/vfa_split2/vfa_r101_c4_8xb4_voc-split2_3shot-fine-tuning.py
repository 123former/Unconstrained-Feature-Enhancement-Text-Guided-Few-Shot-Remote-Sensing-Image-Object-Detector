...
evaluation = dict(
    interval=1200, class_splits=['BASE_CLASSES_SPLIT2', 'NOVEL_CLASSES_SPLIT2'])
checkpoint_config = dict(interval=1200)
optimizer = dict(lr=0.001)
lr_config = dict(warmup=None)
runner = dict(max_iters=1200*4)
load_from = 'work_dirs/vfa_r101_c4_8xb4_voc-split2_base-training/latest.pth'
