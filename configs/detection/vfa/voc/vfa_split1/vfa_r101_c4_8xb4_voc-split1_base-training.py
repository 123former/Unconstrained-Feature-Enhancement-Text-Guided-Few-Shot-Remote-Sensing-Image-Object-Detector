...
lr_config = dict(warmup_iters=100, step=[12000*4, 16000*4])
evaluation = dict(interval=3000*4)
checkpoint_config = dict(interval=3000*4)
runner = dict(max_iters=18000*4)
