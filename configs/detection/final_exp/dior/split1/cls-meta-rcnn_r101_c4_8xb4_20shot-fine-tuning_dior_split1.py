...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_base-training_dior_split1/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_20shot-fine-tuning_dior_split1'
gpu_ids = [0]
