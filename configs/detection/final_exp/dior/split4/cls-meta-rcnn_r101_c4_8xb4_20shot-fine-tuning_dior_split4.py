...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(type='ann_file', split='SPLIT4', setting='20SHOT')],
...
model = dict(
    ...
    rpn_head=dict(
        ...
        in_channels=1024,
        feat_channels=512,
        base_cpt='./work_dirs/cls-meta-rcnn_r101_c4_8xb4_base-training_dior_split4/latest.pth',
...
log_level = 'INFO'
load_from = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_base-training_dior_split4/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/cls-meta-rcnn_r101_c4_8xb4_20shot-fine-tuning_dior_split4'
gpu_ids = [0]
