...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[
                dict(
                    type='ann_file',
                    ann_file='data/DC/dior_structure/ImageSets/Main/train.txt')
            ],
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file', ann_file='data/DC/dior_structure/ImageSets/Main/test.txt')
        ],
        img_prefix='data/DC/dior_structure/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
seed = 42
work_dir = './work_dirs_dc/meta-rcnn_r101_c4_8xb4_voc-split5_base-training'
gpu_ids = [0]
