...
log_level = 'INFO'
load_from = './work_dirs/gnn_cat_r101_dior-split1_base-training_ms_asy/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/meta-rcnn_r101_c4_8xb4_voc-split1_20shot-fine-tuning_ms_cat_gnn_asy'
gpu_ids = [0]
