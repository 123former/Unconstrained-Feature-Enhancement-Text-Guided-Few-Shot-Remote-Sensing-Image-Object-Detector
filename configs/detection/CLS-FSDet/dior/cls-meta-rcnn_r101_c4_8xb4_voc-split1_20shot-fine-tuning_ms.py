    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file=
                'data/DIOR/VOC2007/ImageSets/Main/test.txt'
            )
        ],
        img_prefix='data/DIOR/',
        pipeline=[
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100)),
    frozen_parameters=[
        'backbone', 'rpn_head', 'shared_head', 'affine_rpn', 'affine_rcnn', 'roi_head.gnn', 'aggregation_layer'
    ]#, 'rpn_head', 'shared_head', 'affine_rpn', 'affine_rcnn', 'roi_head.gnn'
)
...
log_level = 'INFO'
load_from = './work_dirs/gnn_cat_r101_dior-split1_base-training/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/meta-rcnn_r101_c4_8xb4_voc-split1_20shot-fine-tuning_ms_cat_gnn'
gpu_ids = [0]
