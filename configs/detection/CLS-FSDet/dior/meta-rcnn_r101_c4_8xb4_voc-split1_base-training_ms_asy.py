...
lr_config = dict(
    ...
    warmup_ratio=0.001,
    step=[36000])
runner = dict(type='IterBasedRunner', max_iters=42000)
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(type='AsymmetricLoss', class_num=16),
            loss_bbox=dict(type='SmoothL1Loss', loss_weight=1.0),
            num_meta_classes=15,
            meta_cls_in_channels=4096,
            with_meta_cls_loss=True,
            loss_meta=dict(type='AsymmetricLoss', class_num=15)),
...
log_level = 'INFO'
load_from = '/home/f523/disk1/sxp/mmfewshot/work_dirs/gnn_cat_r101_dior-split1_base-training/latest.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/gnn_cat_r101_dior-split1_base-training_ms_asy'
gpu_ids = [0]
